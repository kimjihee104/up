...
/*  @RequestMapping( value="getArtist", method=RequestMethod.GET )
  ...
  */
  ...
  public String getArtist(@PathVariable("artistNo") int artistNo, Model model,HttpSession session) throws  Exception {
      //Business Logic
...
/*    
    ...
    System.out.println("userNo?"+userNo+"artistNo?"+artistNo);
    UserLikeArt userLikeArt = new UserLikeArt(userNo,artistNo);
    
    userLikeArt = userService.getLikeArt(userLikeArt);
    System.out.println(userLikeArt);
    model.addAttribute("artistHeart",userLikeArt);
