...
public class UserController {
  ...
  public String addUser(@ModelAttribute("user") User user,HttpSession session) throws Exception{
    ...
    List<Video> video=videoService.getVideoListHeartTop10();
   ...
   // model.addAttribute("totalCount", map.get("totalcount"));
    ...
    if(user !=null){
      ...
      session.setAttribute("heartList", video);
      session.setAttribute("leaglist",leag);
      session.setAttribute("min",progress);
      session.setAttribute("leaglist",leag);
...
//    return "redirect:/user/getUser?userId="+user.getUserId();
 ...
 /* @RequestMapping( value="login", method=RequestMethod.POST )
  ...
  /////////////
  @RequestMapping( value="login", method=RequestMethod.POST )
  public  @ResponseBody User login(HttpServletRequest req,HttpSession session, Model model ) throws Exception{
 ...
 public @ResponseBody UserLikeArt addLikeArt(@PathVariable("artNo") int artNo, HttpSession session) throws Exception {
  ...
  @RequestMapping(value="deleteUserLikeArt/{artNo}")
 public @ResponseBody User deleteUserLikeArt(@PathVariable("artNo") int artNo, HttpSession session)  throws Exception {
    ...
    userService.deletelikeArtUser(userlikeart);
