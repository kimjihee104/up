...
public List<Video> getVideoListHeartTop10() throws Exception {
    
    System.out.println("getVideoListHeartTop10");
    return sqlSession.selectList("VideoMapper.getVideoListHeartTop10");
	}
